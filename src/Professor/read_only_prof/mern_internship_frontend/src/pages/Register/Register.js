            ...
            <Form>
              <Row>
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  ...
                  <Form.Control type="url" name='linkedin' value={inputdata.linkedin} onChange={setInputValue} placeholder='Enter Your Linkedin Link' />
                </Form.Group>
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  <Form.Label>Enter Your Github Link</Form.Label>
                  <Form.Control type="url" name='github' value={inputdata.github} onChange={setInputValue} placeholder='Enter Your Github link' />
                </Form.Group>
