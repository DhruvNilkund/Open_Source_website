...
const Register = () => {
  ...
  const submitUserData = async(e) => {
    ...
    const { fname, lname, email, mobile, gender, location,collegename,projectname,domain,github,linkedin } = inputdata;
            ...
            <Form>
              <Row>
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  ...
                  <Form.Control type="text" name='linkedin' value={inputdata.linkedin} onChange={setInputValue} placeholder='Enter Your Linkedin Link' />
                </Form.Group>
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  <Form.Label>Enter Your Github Link</Form.Label>
                  <Form.Control type="text" name='github' value={inputdata.github} onChange={setInputValue} placeholder='Enter Your Github link' />
                </Form.Group>
