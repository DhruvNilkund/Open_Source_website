          ...
          <Card className='card-profile shadow col-lg-6 mx-auto mt-5'>
            <Card.Body>
              ...
              <div className='text-center'>
                ...
                <h4>College:&nbsp;:- <span>{userprofile.collegename}</span> </h4>
                <h4>Project:&nbsp;:- <span>{userprofile.projectname}</span> </h4>
                <h4>Domain:&nbsp;:- <span>{userprofile.domain}</span> </h4>
                <h4>Status&nbsp;:- <span>{userprofile.status}</span> </h4>
                <h4>Github&nbsp;:- <span>{userprofile.github}</span> </h4>
                <h4>Linkedin&nbsp;:- <span>{userprofile.linkedin}</span> </h4>
